...
- (void)viewDidLoad
{
    ...
    PFQuery *queryForCredentials = [PFQuery queryWithClassName:@"User"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    PFObject *loginCredentials = self.users[indexPath.row];
    cell.textLabel.text = loginCredentials[@"userName"];
